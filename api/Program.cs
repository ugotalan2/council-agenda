...
builder.Services.AddSingleton<IGoogleDocService, GoogleDocService>();
builder.Services.AddScoped<IAgendaExportService, AgendaExportService>();
...
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowClient", policy =>
    {
        policy.WithOrigins(
            "http://localhost:5173",
            "https://council-agenda.vercel.app"
        )
        .AllowAnyHeader()
        .AllowAnyMethod();
    });
